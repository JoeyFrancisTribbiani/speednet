      ...
      <unicloud-db ref="udb" :collection="collectionList" field="game_name,processes,picture,regions,platform,status" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="select" :filter-data="options.filterData.status_localdata" @filter-change="filterChange($event, 'status')">上架状态</uni-th>
            <uni-th align="center">操作</uni-th>
          </uni-tr>
          <uni-tr v-for="(item,index) in data" :key="index">
            <uni-td align="center">{{item.game_name}}</uni-td>
            <!-- <uni-td align="center" style="width: 200px;">{{item.processes}}</uni-td> -->
            <uni-td align="center">
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/speednet-game.js';
