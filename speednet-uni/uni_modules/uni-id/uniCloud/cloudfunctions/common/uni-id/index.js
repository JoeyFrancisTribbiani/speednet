...
function Xe(e) {
	var t = e.split(".", 1)[0];
	return Je(Qe.from(t, "base64").toString("binary"))
}
...
function Mt(e, t) {
	var r = Ft(e) || function(e) {
		...
		n = r.length,
		i = !!n;
	for (var o in e) !t && !qt.call(e, o) || i && ("length" == o || $t(o, n)) || r.push(o);
	return r
}
		...
		return "number" == typeof e && e == function(e) {
			var t = function(e) {
					...
					if ((e = function(e) {
							...
							e = e.replace(Jt, "");
							var r = Wt.test(e);
							return r || Zt.test(e) ? er(e.slice(2), r ? 2 : 8) : Xt.test(e) ? NaN : +e
						}(e)) === 1 / 0 || e === -1 / 0) {
						return 17976931348623157e292 * (e < 0 ? -1 : 1)
					}
					return e == e ? e : 0
...
var cn = Object.freeze({
		...
		_checkLoginUserList: function(e) {
			if (e && 1 !== e.length) return e[0].status === $ ? {
				code: 10006
			} : {
				code: 10005
			}
		...
		bindRole: async function({
			...
			const n = {};
			return "string" == typeof t && (t = [t]), n.role = r ? t : Xr.push(t), await j.doc(e).update(n), {
				code: 0,
				msg: ""
			}
		},
		bindPermission: async function({
			...
			const n = {};
			return "string" == typeof t && (t = [t]), n.permission = r ? t : Xr.push(t), await P.where({
				role_id: e
			}).update(n), {
				code: 0,
				msg: ""
		...
		deletePermission: async function({
			...
			return await D.where({
				permission_id: Xr.in(e)
			}).remove(), await P.where({
				permission: Xr.elemMatch(Xr.in(e))
			}).update({
				permission: Xr.pullAll(e)
			}), {
				code: 0,
				msg: ""
			}
		...
		createToken: function({
			...
			const i = {
					uid: e,
					cid: this.context.CLIENTID || void 0,
					needPermission: t,
					role: r,
					permission: n
				},
	...
	un = re((function(e, t) {
		...
		function z(e, t, r) {
			(void 0 !== r && !pe(e[t], r) || void 0 === r && !(t in e)) && J(e, t, r)
		}

		function Q(e, t, r) {
			var n = e[t];
			b.call(e, t) && pe(n, r) && (void 0 !== r || t in e) || J(e, t, r)
		}
...
class ln {
	constructor({
		...
		this.pluginConfig = r, this.config = t || this._getConfigContent(), this._configCache = {}, Object
			.defineProperty(this, "context", {
				get() {
					const t = Object.assign({}, e || global.__ctx__ || {}),
						r = ["CLIENTIP", "PLATFORM", "APPID", "LOCALE"];
					for (let e = 0; e < r.length; e++) {
						const i = r[e];
						void 0 === t[i] && console.warn(n.t("context-required", {
							key: i
						}))
					}
					const i = t.APPID,
						o = t.PLATFORM;
					if ("app" === o || "app-plus" === o) {
						const e = this._getAppConfig(this.config, i);
						if (e.preferedAppPlatform) {
							...
							t.PLATFORM = e.preferedAppPlatform
						}
						if ("app" === t.PLATFORM && e["app-plus"] || "app-plus" === t.PLATFORM && e.app)
							throw new Error(
								`Client platform is ${t.PLATFORM}, but ${"app"===t.PLATFORM?"app-plus":"app"} was found in config. Please refer to: https://uniapp.dcloud.net.cn/uniCloud/uni-id?id=prefered-app-platform`
							)
					}
					return t
				}
		...
		if (!uniCloud.initI18n) throw new Error(n.t("hx-version-warning"));
		n = uniCloud.initI18n({
			locale: "en",
			...
			get() {
				return n.setLocale(this.context.LOCALE || "zh-Hans"), n.t.bind(n)
			}
		})
	}
	get dev() {
