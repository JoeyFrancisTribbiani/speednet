<template>
	<view class="content">
		...
		<uni-list class="mt10" :border="false">
			<uni-list-item title="开机启动" :show-switch="true" @switchChange="changeOpenAtLogin"
				:switchChecked="this.isOpenAtLogin"></uni-list-item>
			<uni-list-item title="自动加速" :show-switch="true" @switchChange="changeAutoSpeed"
				:switchChecked="this.isAutoSpeed">
			</uni-list-item>
			</uni-list-item>
		</uni-list>
		<uni-list class="mt10" :border="false">
