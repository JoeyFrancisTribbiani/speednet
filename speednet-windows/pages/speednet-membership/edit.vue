...
<script>
  import { validator } from '../../js_sdk/validator/speednet-membership.js';

  const db = uniCloud.database();
  const dbCollectionName = 'speednet-membership';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("score,balance,comment,start_time,end_time").get().then((res) => {
