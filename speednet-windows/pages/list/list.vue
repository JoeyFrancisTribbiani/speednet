<template>
  <view class="pages">
    ...
    <unicloud-db
      ...
      @error="onqueryerror"
      :collection="'speednet-game'"
      :where="'platform==1 && status==1'"
    ...
    >
      ...
      <uni-list class="uni-list" :border="false" :style="{ height: listHight }">
        ...
        <uni-list-item
          class="game-item"
          :to="'/pages/speednet-game/detail?id=' + item._id"
...
.game-item {
  ...
  background-image: linear-gradient(90deg, #f5fffa, #f5f5f5),
    linear-gradient(90deg, #f5fffa, #f5f5f5);
